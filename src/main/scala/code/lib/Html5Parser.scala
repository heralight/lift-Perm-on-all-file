...
import scala.xml.{MetaData, Null,EntityRef, SpecialNode,
UnprefixedAttribute, PrefixedAttribute, Node, Elem, Atom, Unparsed, TopScope, Text, Comment, Group}
import net.liftweb.util.PCData
...
import net.liftweb.util.{HtmlEntities, Helpers}

object HoistedHtml5 extends HoistedHtml5Parser with HoistedHtml5Writer

trait HoistedHtml5Writer {
  /**
